        ...
        <div class="panel-body">
            <form class="" action="/user" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="firstname" placeholder="firstname {{ $errors->has('firstname') ? 'is-invalid' : '' }}" value="{{ old('firstname') }}">
                    {!! $errors->first('firstname', '<div class="invalid-feedback">:message</div>') !!}
                </div>
                <div class="form-group">
                    <label for="lastname">lastname</label>
                    <input type="text" class="form-control" name="lastname" placeholder="lastname" value="{{ old('lastname') }}" {{ $errors->has('lastname') ? 'is-invalid' : '' }}>
